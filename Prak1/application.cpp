        ...
        switch (ch)
        {
            ...
            case 3:
            {
                ...
                if(result!=NULL)
                {
                    ...
                    {
                        cout << "the equation has an integer solution: x = " << result[0]<< endl;
                    }
                    else
                    {
                        cout << "the equation has two integer solutions: x1 = " << result[0] << "; x2 = " << result[1] << endl;
                    }

                }
                else
                    cout << "the equation has no integer solution!" << endl;
